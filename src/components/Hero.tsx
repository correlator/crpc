  ...
  return (
    <div className="relative bg-blue-700 overflow-hidden">
          ...
          <div className="pt-10 sm:pt-16 lg:pt-8 xl:pt-16">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                ...
                <span className="block text-blue-200">Printer Cartridges</span>
              </h1>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <div className="h-56 w-full bg-blue-800 sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center">
          {/* CRPC Badge Image */}
